...
perform test calls against the API directly from Swagger. ([Instructions for obtaining the token](https://github.com/HackYourFuture-CPH/FP-class11/blob/backend/authentication/firebase-token.md))
